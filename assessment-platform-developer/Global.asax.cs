...
namespace assessment_platform_developer
{
    ...
    public class Global : HttpApplication
    {
        ...
        private static void Bootstrap()
        {
            ...
            //Registering a LocalDb instance. This would be replaced by DB adapater in production
            container.Register(() => { return new LocalDb($"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\CustomerData.json"); }, Lifestyle.Singleton);
